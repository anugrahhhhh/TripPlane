...
<?php 
    ...
    $bodyMail = "<div style='max-width: 100%; border: 1px solid white; border-radius: 5px; box-shadow: 1px 1px 4px lightgrey; padding: 2px 5px 2px 5px; margin: auto; font-family: arial; text-align: center;'><div style='width: 100%; margin-bottom: 2px;'><h1>{$pecahDataPengi['nama_penginapan']}</h1></div><div style='width: 100%; margin-bottom: 2px;'><img src='http://www.TripPlane.web.id/admin-tripplane/dist/img/penginapan-img/{$fotoPenginapan}' alt='Foto penginapan.' style='max-width: 100%;'></div><div style='width: 100%; margin-bottom: 2px;'><h3>Haii Sobat TripPlane</h3></div><div style='width: 100%; margin-bottom: 2px;'><p>Bagaimana kabarmu hari ini sob? Semoga sehat selalu yaa. Oh ya, kali ini mimin update lagi ni info seputar tempat penginapan di Pesisir Selatan, kali ini ada yang baru yaitu <b>{$pecahDataPengi['nama_penginapan']}</b>. Kepoin yukk!!</p></div><div style='width: 100%; margin-bottom: 30px;'><div><p style='margin-bottom: 25px;'>Simak selengkapnya dengan klik tombol dibawah!</p></div><div><a href='http://www.TripPlane.web.id/detail-penginapan.php?id=$idPengiEncode' target='_blank' style='text-decoration: none; color: white; width: 100%; border: 1px solid transparent; border-radius: 5px; outline: none; background-color: red; padding: 10px 20px 10px 20px; font-weight: bolder; font-size: 16px;'>TEMUKAN</a></div></div><hr style='border: 1px solid lightgrey; width: 80%;'><div style='width: 100%;'><p>Klik link dibawah untuk unsubscribe:</p><a href='http://www.TripPlane.web.id/mail/unsubscribe.php?konfirm=unsubs' target='_blank'>Unsubscribe</a></div><div style='width: 100%; margin-bottom: 40px;'><p>Kami selalu ada di:</p><a href='http://www.TripPlane.web.id' target='_blank'>TripPlane.web.id</a><p>&copy; ${tahun}</p></div></div>";
...
<?php
    ...
    try {
        ...
        $mail->Subject = 'Hallo Sobat.. Ada tempat penginapan baru diPesisir Selatan nih!!';
        $mail->Body    = $bodyMail;
