<?php 
  ...
  $ambilDataPeg = $conn->query("SELECT * FROM tbl_wisata JOIN tbl_kategori_wisata ON tbl_wisata.id_kategori_wisata = tbl_kategori_wisata.id_kategori_wisata WHERE tbl_kategori_wisata.kategori_wisata = 'perbukitan' ORDER BY tbl_wisata.id_wisata DESC ");
...
<section class="content-header">
    <div class="container-fluid">
    	<div class="row mb-2">
          	<div class="col-sm-6">
            	<h1>Wisata perbukitan</h1>
          	</div>
	        <div class="col-sm-6">
	            <ol class="breadcrumb float-sm-right">
	              	<li class="breadcrumb-item"><a href="#">Home</a></li>
	              	<li class="breadcrumb-item">Wisata</li>
	              	<li class="breadcrumb-item active">perbukitan</li>
	            </ol>
	        </div>
    	</div>
    </div><!-- /.container-fluid -->
              	...
              	<tbody>
                    ...
                    ?>
                      ...
                      <td>
                        ...
                        <a class="btn btn-danger btn-sm" href="index.php?halaman=hapus-wisata&k=perbukitan&id=<?=$pecahDataPeg['id_wisata']; ?>">
