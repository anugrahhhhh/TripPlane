...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php?halaman=dashboard" class="brand-link">
      ...
      <span class="brand-text font-weight-light">TripPlane</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if($_GET['halaman'] == 'wisata-perbukitan') { ?>
          <li class="nav-item has-treeview menu-open">
            <a href="#" class="nav-link active">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item"> 
                <a href="index.php?halaman=wisata-perbukitan" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Perbukitan</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item"> 
                <a href="index.php?halaman=wisata-perbukitan" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Perbukitan</p>
                </a>
              </li>
          ...
          <?php } else if($_GET['halaman'] == 'edit-wisata') { ?>
            <?php 
              ...
              $pecahKatWis = $ambilkatWis->fetch_assoc();
                if($pecahKatWis["kategori_wisata"] == "perbukitan") {
            ?>
