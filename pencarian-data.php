...
<head>
    ...
    <title>TripPlane | Pencarian</title>
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="media post_item">
                                    <img src="admin-tripplane/dist/img/tour-img/<?=$pecahDataWis['foto_wisata']; ?>" alt="Foto wisata" width="40%" height="80px">
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="media post_item">
                                    <img src="admin-tripplane/dist/img/restaurant-img/<?=$pecahDataRes['foto_restoran']; ?>" alt="Foto restoran" width="40%" height="80px">
                                    <div class="media-body">
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <?php } else { ?>
                                ...
                                <div class="media post_item">
                                    <img src="admin-tripplane/dist/img/penginapan-img/<?=$pecahDataPengi['foto_penginapan']; ?>" alt="Foto penginapan" width="40%" height="80px">
                                    <div class="media-body">
