<?php 
    ...
    // koneksi ke database 
    require "../unsubs/../admin-tripplane/connection/koneksi-database.php";
...
<head>
  ...
  <title>TripPlane | Unsubscribe</title>

  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="../unsubs/../dist/img/logo1.1.png">

  <!-- Google Font: Source Sans Pro -->
  <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  <!-- Font Awesome -->
  <link rel="stylesheet" href="../unsubs/../admin-tripplane/plugins/fontawesome-free/css/all.min.css">
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="../unsubs/../admin-tripplane/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
  <link rel="stylesheet" href="../unsubs/../admin-tripplane/dist/css/adminlte.min.css">
</head>
...
<div class="login-box" id="login-box">
  ...
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <p class="mt-3 mb-1">
        Berubah pikiran? Selalu ada jalan kembali. <a href="http://www.TripPlane.web.id">Batalkan!</a>
      </p>
...
<!-- jQuery -->
<script src="../unsubs/../admin-tripplane/plugins/jquery/jquery.min.js"></script>
<!-- Bootstrap 4 -->
<script src="../unsubs/../admin-tripplane/plugins/bootstrap/js/bootstrap.bundle.min.js"></script>
<!-- AdminLTE App -->
<script src="../unsubs/../admin-tripplane/dist/js/adminlte.min.js"></script>
