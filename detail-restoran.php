...
<head>
   ...
   <title>TripPlane | Detail Restoran</title>
...
<body>
   <!--[if lte IE 9]>
    ...
    <!-- bradcam_area  -->
    <div class="bradcam_area bradcam_bg_4" style="background-image: url(admin-tripplane/dist/img/restaurant-img/<?=$pecahRestoran['foto_restoran']; ?>);">
      <div class="container">
          <div class="row">
              <div class="col-xl-12">
            ...
            <div class="col-lg-8 posts-list">
                ...
                <div class="comment-form" style="border-top: none;">
                  ...
                  <div class="row gallery-item">
                    ...
                    <div class="col-md-8">
                        <a href="admin-tripplane/dist/img/restaurant-gallery/<?=$pecahRestoran['foto_1']; ?>" class="img-pop-up">
                            <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/restaurant-gallery/<?=$pecahRestoran['foto_1']; ?>);"></div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="admin-tripplane/dist/img/restaurant-gallery/<?=$pecahRestoran['foto_2']; ?>" class="img-pop-up">
                            <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/restaurant-gallery/<?=$pecahRestoran['foto_2']; ?>);"></div>
                        </a>
                    </div>
                    <div class="col-md-4">
                        <a href="admin-tripplane/dist/img/restaurant-gallery/<?=$pecahRestoran['foto_3']; ?>" class="img-pop-up">
                            <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/restaurant-gallery/<?=$pecahRestoran['foto_3']; ?>);"></div>
                        </a>
                    </div>
                    <div class="col-md-8">
                        <a href="admin-tripplane/dist/img/restaurant-gallery/<?=$pecahRestoran['foto_4']; ?>" class="img-pop-up">
                            <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/restaurant-gallery/<?=$pecahRestoran['foto_4']; ?>);"></div>
                        </a>
                    </div>
