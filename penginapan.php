...
<head>
    ...
    <title>TripPlane | Penginapan</title>
                    ...
                    <div class="blog_left_sidebar" id="load-penginapan">
                        ...
                        <article class="blog_item">
                            <div class="blog_item_img">
                                <img class="card-img rounded-0" src="admin-tripplane/dist/img/penginapan-img/<?=$pecahDataPengi['foto_penginapan']; ?>" alt="Foto penginapan">
                            ...
                            <ul class="instagram_row flex-wrap">
                                ...
                                <li>
                                    <a href="detail-penginapan.php?id=<?=base64_encode($pecahFotoGalPengi['id_penginapan']); ?>">
                                        <img class="" src="admin-tripplane/dist/img/lodging-gallery/<?=$pecahFotoGalPengi['foto_1']; ?>" alt="Foto galeri penginapan" width="100%" height="60px">
                                    </a>
                                </li>
                                <?php } ?>
