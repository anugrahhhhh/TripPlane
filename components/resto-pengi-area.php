        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_trip">
                    <div class="thumb">
                        <img src="admin-tripplane/dist/img/restaurant-img/<?=$pecahDataResBaru['foto_restoran']; ?>" alt="Foto restoran" height="200px">
                    </div>
                    <div class="info">
                        <div class="date">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="single_trip">
                    <div class="thumb">
                        <img src="admin-tripplane/dist/img/penginapan-img/<?=$pecahDataPengiBaru['foto_penginapan']; ?>" alt="Foto penginapan" height="200px">
                    </div>
                    <div class="info">
                        <div class="date">
