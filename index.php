            ...
            <div class="single_slider  d-flex align-items-center slider_bg_2 overlay">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-12 col-md-12">
                            <div class="slider_text text-center">
                                <h3>Pantai Manjuto</h3>
                                <p>Sunset dipantai Pesisir Selatan</p>
                                <a href="#destinasi-wisata" class="boxed-btn3">Telusuri Sekarang</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        ...
                        <p>Anda akan selalu dimanjakan dengan banyak tempat wisata baru yang sedang hits dan populer di Pesisir Selatan, dengan pemandangan indah yang memanjakan mata juga berbagai fasilitasnya.</p>
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="single_destination">
                        <div class="thumb">
                            <img src="admin-tripplane/dist/img/tour-img/<?=$pecahDataWisBaru['foto_wisata']; ?>" alt="Foto wisata" height="230px">
                        </div>
                        <div class="content">
