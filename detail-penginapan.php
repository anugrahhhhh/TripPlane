<?php 
  ...
  // ambil id penginapan yang ada diurl
  $idPenginapan = base64_decode($_GET["id"]);

  // ambil data penginapan pada tabel penginapan sesuai id penginapan yg dipilih
  $ambilPenginapan = $conn->query("SELECT * FROM tbl_penginapan JOIN tbl_galeri_penginapan ON tbl_penginapan.id_penginapan = tbl_galeri_penginapan.id_penginapan WHERE tbl_penginapan.id_penginapan = '$idPenginapan' ");
  $pecahPenginapan = $ambilPenginapan->fetch_assoc();

  // cek jika id di url kosong atau bukan angka
  if(empty($idPenginapan) || !intval($idPenginapan)) {
      // alihkan ke halaman penginapan
      echo "<script>location ='penginapan.php';</script>";
      header('Location: penginapan.php');
      exit();
  }
  // cek ada data yang dicari tidak
  $adaDataTidak = $ambilPenginapan->num_rows;
...
<head>
   ...
   <title>TripPlane | Detail Penginapan</title>
...
<body>
   <!--[if lte IE 9]>
    ...
    <!-- bradcam_area  -->
    <div class="bradcam_area bradcam_bg_4" style="background-image: url(admin-tripplane/dist/img/penginapan-img/<?=$pecahPenginapan['foto_penginapan']; ?>);">
      <div class="container">
          <div class="row">
              <div class="col-xl-12">
                  <div class="bradcam_text text-center">
                      <h3><?=$pecahPenginapan["nama_penginapan"]; ?></h3>
          ...
          <div class="col-lg-8 posts-list">
            <div class="single-post">
              ...
              <div class="blog_details">
                 <p class="excert">
                    <?=$pecahPenginapan["deskripsi_penginapan"]; ?>
                 </p>
              </div>
              ...
              <div class="blog_details pt-2">
                 <p class="excert">
                  ...
                  <span><strong>Alamat : </strong><?=$pecahPenginapan["alamat_penginapan"]; ?></span><br>
                  <span><strong>Telepon/(WA) : </strong><?=$pecahPenginapan["nomor_telepon"]; ?></span>
            ...
            <div class="comment-form" style="border-top: none;">
              <h3>Galeri Penginapan</h3>
              <div class="row gallery-item">

                <!-- jika ada foto galari & jika tidak ada foto galeri -->
                <?php if($pecahPenginapan['foto_1'] == "") { ?>
                ...
                <div class="col-md-8">
                    <a href="admin-tripplane/dist/img/lodging-gallery/<?=$pecahPenginapan['foto_1']; ?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/lodging-gallery/<?=$pecahPenginapan['foto_1']; ?>);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="admin-tripplane/dist/img/lodging-gallery/<?=$pecahPenginapan['foto_2']; ?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/lodging-gallery/<?=$pecahPenginapan['foto_2']; ?>);"></div>
                    </a>
                </div>
                <div class="col-md-4">
                    <a href="admin-tripplane/dist/img/lodging-gallery/<?=$pecahPenginapan['foto_3']; ?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/lodging-gallery/<?=$pecahPenginapan['foto_3']; ?>);"></div>
                    </a>
                </div>
                <div class="col-md-8">
                    <a href="admin-tripplane/dist/img/lodging-gallery/<?=$pecahPenginapan['foto_4']; ?>" class="img-pop-up">
                        <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/lodging-gallery/<?=$pecahPenginapan['foto_4']; ?>);"></div>
                    </a>
                </div>
              ...
              <div class="row gallery-item mt-4">
                <div class="col-md-12">
                  ...
                  <iframe width="100%" height="450" src="<?=$pecahPenginapan['video_youtube']; ?>" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            ...
            <div class="map-area">
                ...
                <iframe src="<?=$pecahPenginapan['peta_area']; ?>" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
