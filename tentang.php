                    ...
                    <div class="row">
                        <div class="col-lg-11 offset-lg-1">
                            <div class="story_info">
                                <div class="row">
                                    <div class="col-lg-9">
                                    <p>Kami adalah penyedia layanan informasi seputar pariwisata dikabupaten Pesisir Selatan Sumatera Barat indonesia,
                                        kami selaku media yang selalu update dan konsisten dengan pelayanan informasi yang kami sajikan, 
                                        terutama yang berkaitan dengan pariwisata diPesisir Selatan ini. 
                                        Kami juga tidak berhenti disitu, 
                                        selain menyediakan informasi pariwisata kami juga menyediakan informasi seputar tempat kuliner dan tempat penginapan yang ada di Pesisir Selatan.</p>
                                    <p>Upaya kami dalam mendukung program pemerintah dalam mempromosikan tempat-tempat wisata 
                                        Pesisir Selatan ini diharapkan dapat mendongkrak pariwisata Pesisir Selatan agar lebih banyak dikunjungi banyak wisatawan dari berbagai daerah. 
                                        Kami selalu berusaha meningkatkan kualitas pelayanan kami, dan kami tidak dapat melakukannya tanpa bantuan anda.</p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-5 col-md-6">
                                        <div class="thumb padd_1">
                                            <img src="dist/img/about/bupatipessel.jpg" alt="Gambar Bupati Pesisir Selatan">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="thumb">
                                            <img src="dist/img/about/wabuppessel.jpg" alt="Gambar Wakil Pesisir Selatan">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4">
                                        <div class="single_counter text-center">
                                            ...
                                            <p>Total penginapan diPesisir Selatan</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
