...
<head>
    ...
    <title>TripPlane | Detail Wisata</title>
...
<body>
    ...
    <div class="destination_banner_wrap overlay" style="background-image: url(admin-tripplane/dist/img/tour-img/<?=$pecahWisata['foto_wisata']; ?>);">
                ...
                <div class="col-lg-8 col-md-9">
                    ...
                    <div class="section-top-border" style="border-top: none;">
                        ...
                        <div class="row gallery-item">
                            ...
                            <div class="col-md-8">
                                <a href="admin-tripplane/dist/img/tour-gallery/<?=$pecahWisata['foto_1']; ?>" class="img-pop-up">
                                    <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/tour-gallery/<?=$pecahWisata['foto_1']; ?>);"></div>
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="admin-tripplane/dist/img/tour-gallery/<?=$pecahWisata['foto_2']; ?>" class="img-pop-up">
                                    <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/tour-gallery/<?=$pecahWisata['foto_2']; ?>);"></div>
                                </a>
                            </div>
                            <div class="col-md-4">
                                <a href="admin-tripplane/dist/img/tour-gallery/<?=$pecahWisata['foto_3']; ?>" class="img-pop-up">
                                    <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/tour-gallery/<?=$pecahWisata['foto_3']; ?>);"></div>
                                </a>
                            </div>
                            <div class="col-md-8">
                                <a href="admin-tripplane/dist/img/tour-gallery/<?=$pecahWisata['foto_4']; ?>" class="img-pop-up">
                                    <div class="single-gallery-image" style="background: url(admin-tripplane/dist/img/tour-gallery/<?=$pecahWisata['foto_4']; ?>);"></div>
                                </a>
                            </div>
